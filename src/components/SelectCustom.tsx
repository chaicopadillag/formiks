...
export const SelectCustom: FC<SelectCustomProps> = ({ label, ...rest }) => {
  ...
  return (
    <>
      ...
      <select className='block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner' {...field} {...rest} />
